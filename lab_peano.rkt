...
#|-------------------------------------------------------------------------------
 ...
 | Pledge: I pledge my honor that I have abided by the Stevens System
 |-------------------------------------------------------------------------------|#
...
(define (p-prime? p)
  "implement"
  (if (orFunc(pz? p) (p= p (succ z)))
      #f
      (prime-helper p (succ (succ z))))
)
(define (prime-helper p n)
  (if (p> p n)
      (if (p-divides? n p)
          #f
          (prime-helper p (succ n)))
      #t)
