...
(define (CRT-exists-helper a L)
  (if (null? L)
      #t
      (if (= 1 (gcd a (car (cdr (car L)))))
          (CRT-exists-helper a (cdr L))
          #f))
)
...
(define (CRT-exists? L)
  ...
  (if (null? L)
      ...
      (if (null? (cdr L))
          #t
          (if (CRT-exists-helper (car (cdr (car L))) (cdr L))
              (CRT-exists? (cdr L))
              #f)))
)
...
(define (CRT-helper L m)
  ...
  (if (null? L)
      0
      (if (null? (cdr L))
          (* (car (car L)) (* (/ m (car (cdr (car L)))) (mod-inverse (/ m (car (cdr (car L)))) (car (cdr (car L))))))
          (+  (* (car (car L)) (* (/ m (car (cdr (car L)))) (mod-inverse (/ m (car (cdr (car L)))) (car (cdr (car L)))))) (CRT-helper (cdr L) m))))
)
